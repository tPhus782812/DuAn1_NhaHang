    ...
    <div class="container my-5 py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="display-3 text-white animated slideInLeft">Tận Hưỡng<br>Bữa Ăn Ngon</h1>
                <p class="text-white animated slideInLeft mb-4 pb-2">Hãy đặt chân đến nhà hàng của chúng tôi và khám phá những câu chuyện ẩn sau mỗi món ăn, nơi sự sáng tạo và tình yêu với ẩm thực gặp nhau.</p>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item rounded pt-3">
                    <div class="p-4">
                        ...
                        <h5>Đầu Bếp</h5>
                        <p>Đầu bếp tài năng và đam mê tạo ra những bữa ăn tinh tế và độc đáo, để bạn có trải nghiệm ẩm thực không giới hạn.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item rounded pt-3">
                    <div class="p-4">
                        ...
                        <h5>Thực Phẩm</h5>
                        <p?>Sử dụng thực phẩm chất lượng cao, đảm bảo món bạn thưởng thức là một hòa quyện của vị ngon và chất lượng.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item rounded pt-3">
                    <div class="p-4">
                        ...
                        <h5>Đặt bàn</h5>
                        <p>Đặt bàn trực tuyến ngay hôm nay để dễ dàng tận hưởng bữa ăn đặc biệt của chúng tôi và trải nghiệm dịch vụ chuyên nghiệp.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item rounded pt-3">
                    <div class="p-4">
                        ...
                        <h5>Dịch Vụ 24/7</h5>
                        <p>Sẵn sàng phục vụ bạn 24/7, để đảm bảo rằng bạn có thể tận hưởng bữa ăn ngon bất kỳ lúc nào bạn mong muốn.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Chào mừng đén với <i class="fa fa-utensils text-primary me-2"></i>Restoran</h1>
                <p class="mb-4">Chào mừng bạn đến với nhà hàng của chúng tôi, nơi mà ẩm thực trở thành một nghệ thuật đầy màu sắc và đậm đà. Với đội ngũ đầu bếp tài năng, chúng tôi tự hào mang đến cho bạn những trải nghiệm ẩm thực độc đáo, từ món ăn truyền thống đến sáng tạo và hiện đại.</p>
                <p class="mb-4">Hãy đến và tham quan nhà hàng của chúng tôi, để khám phá vị ngon và đắm chìm trong không gian sang trọng và ấm cúng. Chúng tôi sẵn sàng đón tiếp bạn và tạo ra những kỷ niệm đáng nhớ cùng với bạn. Hãy để chúng tôi mang đến cho bạn một trải nghiệm ẩm thực không giới hạn. Xin chân thành cảm ơn vì đã lựa chọn đến với nhà hàng của chúng tôi.</p>
                ...
                <a class="btn btn-primary py-3 px-5 mt-2" href="index.php?pg=about">Đọc Thêm</a>
            </div>
        </div>
    </div>
</div>
...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        <div class="text-center">
            ...
            <h1 class="mb-5">Đánh Giá Từ Khách Hàng!!!</h1>
        </div>
