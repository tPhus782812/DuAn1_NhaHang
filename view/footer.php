    ...
    <script src="view/layout/assets/lib/wow/wow.min.js"></script>
    <script src="view/layout/assets/lib/easing/easing.min.js"></script>
    <script src="view/layout/assets/lib/waypoints/waypoints.min.js"></script>
    <script src="view/layout/assets/lib/counterup/counterup.min.js"></script>
    <script src="view/layout/assets/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="view/layout/assets/lib/tempusdominus/js/moment.min.js"></script>
    <script src="view/layout/assets/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="view/layout/assets/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
